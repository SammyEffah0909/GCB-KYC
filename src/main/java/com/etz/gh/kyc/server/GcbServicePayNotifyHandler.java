 ...
 */
public class GcbServicePayNotifyHandler implements HttpHandler {
...
//        ExchangeUtils.setHeader(exchange, Headers.CONTENT_TYPE, Config.CONTENT_TYPE_TEXT_PLAIN);
        ...
        try {
            ...
            if (isIPAllowed(exchange)) {
                ...
                if (bankRef != null && fullName != null && phoneNumber != null && formType != null && serviceKey != null) {
                    LOG_PREFIX = bankRef + "***" + phoneNumber + " ";
                    String resp = new GcbClient().servicePayNotify(serviceKey, formType, bankRef, fullName, phoneNumber);
                    if (resp != null) {
